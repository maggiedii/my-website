...
The root Vercel Functions use plain CommonJS `.js` handlers so Vercel executes them consistently under the Node.js runtime without relying on ESM module detection.
